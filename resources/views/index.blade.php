      ...
      <div class="main">
        ...
        <section class="contenedor">
            <div class="historia">
              ...
              <div class="historiaimagen">
                <img style="width:100%;" src="{{asset("images/cerveza-historia2.jpg")}}">
              </div>
        </section>
        ...
        <div class="cervezas">
            <div class="margen">
              ...
              <div class="pilsener">
                <div class="fotomobile">
                  <img src="{{asset("images/barrockventa4.png")}}" style="width:100%;">
                </div>
                <div class="textoBirra">
                  <h3>LAS PILSENER</h3>
                  <p id = "descripcionBirra">
            ...
            <a href="{{ url('products') }}" style="text-decoration: none;">
              <div class="amber">
                <div class="fotomobile">
                  <img src="{{asset("images/barrockventa5.png")}}" style="width:100%;">
                </div>
                <div class="textoBirra">
                  <h3>AMBER LAGER</h3>
                  <p id = "descripcionBirra">
            ...
            <a href="{{ url('products') }}" style="text-decoration: none;">
              <div class="honey">
                <div class="fotomobile">
                  <img src="{{asset("images/barrockventa6.png")}}" style="width:100%;">
                </div>
                <div class="textoBirra">
                  <h3>HONEY</h3>
                  <p id = "descripcionBirra">
